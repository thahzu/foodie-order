...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        /*Tooltip cho phần hỗ trợ*/
        $(function () {
            $('[data-toggle="tooltip"]').tooltip()
        })
    </script>

    <%--Chức năng vô hiệu hóa nút quay lại--%>
            ...
            <div class="row pb-5">
                <div class="col-lg-6 mx-auto">
                    <div class="card ">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="credit-card" class="tab-pane fade show active pt-3">
                                    <div role="form">
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvName" runat="server" ErrorMessage="Vui lòng nhập tên chủ thẻ"
                                            ...
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                                                ErrorMessage="Tên phải bao gồm ký tự chữ cái" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvCardNo" runat="server" ErrorMessage="Vui lòng nhập số thẻ"
                                                ControlToValidate="txtCardNo" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"
                                                ValidationGroup="card">*</asp:RequiredFieldValidator>
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                                ErrorMessage="Số thẻ phải gồm 16 chữ số" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <div class="form-group">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="rfvExpMonth" runat="server" ErrorMessage="Vui lòng nhập tháng hết hạn"
                                                        ControlToValidate="txtExpMonth" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"
                                                        ValidationGroup="card">*</asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" Display="Dynamic"
                                                        ErrorMessage="Tháng hết hạn phải gồm 2 chữ số" ForeColor="Red" SetFocusOnError="true"
                                                        ValidationExpression="[0-9]{2}" ControlToValidate="txtExpMonth" ValidationGroup="card">*
                                                    </asp:RegularExpressionValidator>
                                                    <asp:RequiredFieldValidator ID="rfvExpYear" runat="server" ErrorMessage="Vui lòng nhập năm hết hạn"
                                                        ControlToValidate="txtExpYear" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"
                                                        ValidationGroup="card">*</asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" Display="Dynamic"
                                                        ErrorMessage="Năm hết hạn phải gồm 4 chữ số" ForeColor="Red" SetFocusOnError="true"
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group mb-4">
                                                    <label data-toggle="tooltip" title="Mã bảo mật CVV là ba chữ số phía sau thẻ của bạn">
                                                        <h6>CVV <i class="fa fa-question-circle d-inline"></i></h6>
                                                    </label>
                                                    <asp:RequiredFieldValidator ID="rfvCvv" runat="server" ErrorMessage="Vui lòng nhập mã CVV"
                                                        ControlToValidate="txtCvv" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"
                                                        ValidationGroup="card">*</asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" Display="Dynamic"
                                                        ErrorMessage="CVV phải gồm 3 chữ số" ForeColor="Red" SetFocusOnError="true"
                                                        ValidationExpression="[0-9]{3}" ControlToValidate="txtCvv" ValidationGroup="card">*
                                                    </asp:RegularExpressionValidator>
                                                    <asp:TextBox ID="txtCvv" runat="server" CssClass="form-control" placeholder="Mã CVV"
                                                        TextMode="Number"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvAddress" runat="server" ErrorMessage="Vui lòng nhập địa chỉ" ForeColor="Red"
                                ...
                                <div id="paypal" class="tab-pane fade pt-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvCODAddress" runat="server" ErrorMessage="Vui lòng nhập địa chỉ" ForeColor="Red"
                                    ...
                                    <p class="text-muted">
                                        Lưu ý: Khi nhận được đơn hàng, bạn cần thanh toán đầy đủ. Sau khi hoàn thành quá trình thanh toán, bạn có thể kiểm tra trạng thái đơn hàng đã cập nhật.
                                    </p>
                                </div>
                                <!-- Kết thúc -->
                            </div>
                        ...
                        <div class="card-footer">
                            <b class="badge badge-success badge-pill shadow-sm">Tổng Tiền Đơn Hàng:  <% Response.Write(Session["grandTotalPrice"]); %> </b>
                            <div class="pt-1">
