...
%>"
                                    ...
                                    <div class="userData ml-3">
                                        <h2 class="d-block" style="font-size: 1.5rem; font-weight: bold">
                                            <a href="javacript:void(0);"><%Response.Write(Session["name"]); %></a>
                                        </h2>
                                        <h6 class="d-block">
                                        ...
                                        <h6 class="d-block">
                                            <a href="javascript:void(0)">
                                                <asp:Label ID="lblEmail" runat="server" ToolTip="Email của người dùng">
                                        ...
                                        <h6 class="d-block">
                                            <a href="javascript:void(0)">
                                                <asp:Label ID="lblCreatedDate" runat="server" ToolTip="Tài khoản được tạo vào ngày">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link text-info" id="connectedServices-tab" data-toggle="tab" href="#connectedServices"
                                                ...
                                                <i class="fa fa-clock-o mr-2"></i>Lịch Sử Đặt Hàng</a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="tab-content ml-1" id="myTabContent">
                                       ...
                                       <%-- Lịch Sử Đặt Hàng--%>
                                        <div class="tab-pane fade" id="connectedServices" role="tabpanel" aria-labelledby="ConnectedService-tab">
